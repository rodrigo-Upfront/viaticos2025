...
from app.routers import (
    ...
    prepayments, expense_reports, expenses, approvals, dashboard, statements
)
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://frontend:3000", "http://161.35.39.205:3000", "http://161.35.39.205"],
